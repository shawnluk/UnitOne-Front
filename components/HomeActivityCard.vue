  ...
  >
    <view class="cover-wrap">
      ...
      <view class="cover-chip">
        <text class="cover-chip-text">{{ data.joinCount }}人热度</text>
      </view>
    </view>
    ...
    <view class="main">
      ...
      <view class="tag-row" v-if="data.tagText || data.tag_text">
      ...
      <view class="meta">
        <view class="meta-row time-row">
          <view class="time-pill">
            <text class="time-pill-ico">⏰</text>
            <text class="time-pill-label">活动时间:</text>
            <text class="time-pill-text" :number-of-lines="1">{{ data.time_text }}</text>
          </view>
        </view>
        <view class="meta-row location-row">
          <view class="location-pill">
            <text class="location-pill-ico">📍</text>
            <text class="location-pill-label">活动地点:</text>
            <text class="location-pill-text">{{ data.location_text }}</text>
          </view>
        </view>
      </view>
    </view>
    ...
    <view class="footer">
      ...
      <view class="join">
        ...
        <text class="join-text">{{ data.joinCount }}人参加</text>
      </view>
    </view>
  </view>
</template>
