	...
	export default {
		...
		data() {
			return {
				...
				Number : 0,
				categoryItems: [
					{ acid:1,key: 'sport', text: '约球', icon: 'https://unitone-1310134019.cos.ap-guangzhou.myqcloud.com/test/e_000109_r.png' ,isActive:false},
					{ acid:2,key: 'movie', text: '观影', icon: 'https://unitone-1310134019.cos.ap-guangzhou.myqcloud.com/test/e_000103_r.png' ,isActive:false},
					{ acid:3,key: 'outdoor', text: '户外', icon: 'https://unitone-1310134019.cos.ap-guangzhou.myqcloud.com/test/e_000108_r.png' ,isActive:false},
					{ acid:4,key: 'chat', text: '闲聊', icon: 'https://unitone-1310134019.cos.ap-guangzhou.myqcloud.com/test/e_000102_r_ll.png' ,isActive:false},
					{ acid:5,key: 'art', text: '艺术', icon: 'https://unitone-1310134019.cos.ap-guangzhou.myqcloud.com/test/e_000100_r_w.png',isActive:false},
					{ acid:6,key: 'subscribe', text: '订阅', icon: 'https://unitone-1310134019.cos.ap-guangzhou.myqcloud.com/test/e_000109_r.png', badge: true,isActive:false },
				],
				activityList:[
					{
						acid:1,
						name:"1-1",
						isActive:false,
						cover:"https://unitone-1310134019.cos.ap-guangzhou.myqcloud.com/test/e_000100_r_w.png",
						title:"标题-1",
						locationText:"地址-1",
						timeText:"时间",
